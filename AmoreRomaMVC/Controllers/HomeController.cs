using AmoreRomaMVC.Models;
using Microsoft.AspNetCore.Mvc;
using System.Diagnostics;
using System.Text.RegularExpressions;

namespace AmoreRomaMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken] //class present in application
        public IActionResult Reverse(Palindrome palindrome)
        {
            ...
            revWord = Regex.Replace(revWord.ToLower(),"[^a-zA-Z0-9]+",""); //replace items by void
            inputWord = Regex.Replace(inputWord.ToLower(), "[^a-zA-Z0-9]+", ""); //verify items in input
